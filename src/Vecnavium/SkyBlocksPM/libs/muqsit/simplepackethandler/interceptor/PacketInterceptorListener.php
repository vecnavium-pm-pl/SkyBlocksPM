...
namespace Vecnavium\SkyBlocksPM\libs\muqsit\simplepackethandler\interceptor;

use Closure;
use Vecnavium\SkyBlocksPM\libs\muqsit\simplepackethandler\utils\ClosureSignatureParser;
